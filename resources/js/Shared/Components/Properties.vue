<template>
  ...
  >
    <div
      class="bg-1 flex flex-col justify-between w-full h-32 flex-none text-gray-500 border-b-4 border-b-gray-200"
    >
      <div
      ...
      <div
        v-if="Object.keys(project.data).length > 0"
    ...
    <div
      class="bg-1 flex flex-col justify-between w-full flex-grow text-gray-500"
    >
      <div
        class="bg-1 h-6 flex items-center justify-between p-1 border-b border-b-gray-200"
      >
