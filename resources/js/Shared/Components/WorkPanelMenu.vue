<template>
  <div class="bg-gray-100 h-8 flex">
    <button
      class="h-full px-3 border-r border-r-white cursor-pointer flex items-center hover:bg-white hover:text-blue-800"
      :class="state.window == 'file' ? 'bg-white text-blue-800' : ''"
      @click.stop="state.window = 'file'"
    >
    ...
    <div
      class="h-full px-3 border-r border-r-white cursor-pointer flex items-center hover:bg-white hover:text-blue-800"
      :class="state.window == 'wysiwyg' ? 'bg-white text-blue-800' : ''"
      @click.stop="state.window = 'wysiwyg'"
    >
      <svg class="w-5 h-5 mr-1" viewBox="0 0 24 24">
        <path
          fill="currentColor"
    ...
    <div
      class="h-full px-3 border-r border-r-white cursor-pointer flex items-center hover:bg-white hover:text-blue-800"
      :class="state.window == 'code' ? 'bg-white text-blue-800' : ''"
      @click.stop="state.window = 'code'"
    >
      <svg class="w-5 h-5 mr-1" viewBox="0 0 24 24">
        <path
          fill="currentColor"
    ...
    <div
      class="h-full px-3 border-r border-r-white cursor-pointer flex items-center hover:bg-white hover:text-blue-800"
      :class="state.window == 'preview' ? 'bg-white text-blue-800' : ''"
      @click.stop="state.window = 'preview'"
    >
      <svg class="w-5 h-5 mr-1" viewBox="0 0 24 24">
        <path
          fill="currentColor"
    ...
    <div
      class="h-full px-3 border-r border-r-white cursor-pointer flex items-center hover:bg-white hover:text-blue-800"
      :class="state.window == 'help' ? 'bg-white text-blue-800' : ''"
      @click.stop="state.window = 'help'"
    >
      <svg class="w-5 h-5 mr-1" viewBox="0 0 24 24">
        <path
          fill="currentColor"
