<template>
  <div class="bg-gray-100 h-8 flex">
    <div
      class="h-full px-3 border-r border-r-gray-50 cursor-pointer flex items-center bg-white"
    >
    ...
    <div
      class="h-full px-3 border-r border-r-gray-50 cursor-pointer flex items-center"
    >
      WysiWyg
    </div>
    <div
